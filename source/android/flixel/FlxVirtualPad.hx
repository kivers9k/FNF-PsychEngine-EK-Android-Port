	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode, ?alphaAlt:Float = 0.75, ?antialiasingAlt:Bool = true) {
		...
		switch (DPad){
			...
			case DEBUG_PAD:
				...
				dPad.add(add(buttonRight = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "right")));
		...
		switch (Action){
			...
			case DEBUG_ACTION:
				...
				actions.add(add(buttonY = createButton(FlxG.width - 212 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "y")));
			case NONE:
		}
	}
