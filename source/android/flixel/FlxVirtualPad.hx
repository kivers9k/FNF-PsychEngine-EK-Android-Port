...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	private function createButton(X:Float, Y:Float, Graphic:String, Color:Int = 0xFFFFFF):FlxButton
	{
		...
		if (Assets.exists('assets/preload/images/android/${Graphic}.png'))
			graphic = FlxG.bitmap.add('assets/preload/images/android/${Graphic}.png');
		else
			graphic = FlxG.bitmap.add('assets/preload/images/android/default.png');
